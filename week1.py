...
#         result = b * b - 4 * a * c
#         self.string_variable.set(result)
#     def __init__(self):
#         self.main_window = tkinter.Tk()
...
#         self.string_variable = tkinter.StringVar(self.main_window)
#         self.label5 = tkinter.Label(self.button_frame, textvariable=self.string_variable)
#         self.button=tkinter.Button(self.button_frame,text='Compute',command= self.get_result)
#
...
class Exercise4:
    ...
    def __init__(self):
        ...
        self.label_result=tkinter.Label(self.bottom_frame,textvariable=self.string_variable)
        self.label_result.pack(side='bottom')

        self.button=tkinter.Button(self.bottom_frame,text='Calculate',command=self.on_change)
        self.button.pack()
