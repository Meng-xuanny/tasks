...
class Exercise3:
    def __init__(self):
        ...
        self.button=tkinter.Button(self.button_frame,text='Compute',command=lambda: get_result(self))
...
#         # result=string_variable.get()
#         self.label5 = tkinter.Label(self.window, text=f"the average acceleration is: {a} m/s")
#         self.label5.pack()
#
#
#
